...
// $empresas: viene del AreaController::create() para el combo
// $areasPorEmpresa: lista de áreas existentes para combo de área padre
...
<head>
  <meta charset="UTF-8" />
  <title>Nueva área · Administración organizacional</title>
...
<body class="min-h-screen bg-white text-vc-ink font-sans relative">
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 py-8 relative">
    ...
    <section class="flex flex-col gap-2 mb-4">
      <h1 class="vice-title text-[36px] leading-tight text-vc-ink">Nueva área</h1>
      <p class="text-sm sm:text-base text-muted-ink">
        Registra una nueva área o departamento dentro de una empresa.
      </p>
    ...
    <section class="mt-2">
      <div class="bg-white/95 rounded-xl border border-black/10 shadow-soft p-6 sm:p-8 relative z-10">
        <form id="formArea" method="POST" action="<?= url('index.php?controller=area&action=store') ?>" class="space-y-6">
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                <!-- Las demás opciones se llenan con JS según la empresa -->
              </select>
