...
$submodules = [
  ['title' => 'Empresas', 'sub' => 'Razón social, RFC y contacto',  'icon' => 'bi-building',          'href' => url('views/organizacional/empresas/list.php')],
  ['title' => 'Áreas',                'sub' => 'Organización interna',          'icon' => 'bi-diagram-3',         'href' => url('views/organizacional/areas/list.php')],
