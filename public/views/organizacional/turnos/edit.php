...
// Si por alguna razón no hubiese nada, por defecto L-V
...
<head>
  <meta charset="UTF-8" />
  <title>Editar turno · Administración organizacional</title>
...
<body class="min-h-screen bg-white text-vc-ink font-sans relative">
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 py-8 relative">
    ...
    <section class="flex flex-col gap-2 mb-4">
      <h1 class="vice-title text-[36px] leading-tight text-vc-ink">Editar turno</h1>
      <p class="text-sm sm:text-base text-muted-ink">
        Actualiza la configuración del turno laboral.
      </p>
    ...
    <section class="mt-2">
      <div class="bg-white/95 rounded-xl border border-black/10 shadow-soft p-6 sm:p-8 relative z-10">
        ...
        <form
          id="formTurno"
          method="POST"
          action="<?= url('index.php?controller=turno&action=update&id=' . $idTurno) ?>"
          class="space-y-6"
        >
          <!-- Nombre turno -->
          <div>
            ...
            <div class="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  <?= diaChecked($diasSeleccionados, 'L') ?>
                >
                <span>Lunes (L)</span>
              </label>
              ...
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  value="M"
                  class="rounded border-black/20 text-vc-teal focus:ring-vc-teal"
                  <?= diaChecked($diasSeleccionados, 'M') ?>
                >
                <span>Martes (M)</span>
              </label>
              ...
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  value="X"
                  class="rounded border-black/20 text-vc-teal focus:ring-vc-teal"
                  <?= diaChecked($diasSeleccionados, 'X') ?>
                >
              ...
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  value="J"
                  class="rounded border-black/20 text-vc-teal focus:ring-vc-teal"
                  <?= diaChecked($diasSeleccionados, 'J') ?>
                >
                <span>Jueves (J)</span>
              </label>
              ...
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  value="V"
                  class="rounded border-black/20 text-vc-teal focus:ring-vc-teal"
                  <?= diaChecked($diasSeleccionados, 'V') ?>
                >
                <span>Viernes (V)</span>
              </label>
              ...
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  value="S"
                  class="rounded border-black/20 text-vc-teal focus:ring-vc-teal"
                  <?= diaChecked($diasSeleccionados, 'S') ?>
                >
                <span>Sábado (S)</span>
              </label>
              ...
              <label class="inline-flex items-center gap-2">
                <input
                  ...
                  value="D"
                  class="rounded border-black/20 text-vc-teal focus:ring-vc-teal"
                  <?= diaChecked($diasSeleccionados, 'D') ?>
                >
                <span>Domingo (D)</span>
              </label>
            </div>
