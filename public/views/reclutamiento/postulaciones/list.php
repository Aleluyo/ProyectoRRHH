    ...
    <main class="mx-auto max-w-7xl px-4 sm:px-6 py-8 relative">
        ...
        <section class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <form method="get" class="flex flex-col sm:flex-row gap-3 sm:items-center">
                ...
                <a href="<?= url('index.php?controller=postulacion&action=create') ?>"
                            ...
                            <?php foreach ($postulaciones as $p): ?>
                                ...
                                <tr class="border-t border-slate-200 hover:bg-slate-50">
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap text-xs">
                                        ...
                                        elseif ($estado === 'SCREENING')
                                            $badgeClass = 'bg-amber-100 text-amber-800';
                                        elseif ($estado === 'POSTULADO')
                                            $badgeClass = 'bg-slate-100 text-slate-700';
                                        elseif ($estado === 'OFERTA')
                                            $badgeClass = 'bg-emerald-100 text-emerald-800';
                                        elseif ($estado === 'CONTRATADO')
                                            $badgeClass = 'bg-emerald-200 text-emerald-900';
                                        elseif ($estado === 'RECHAZADO')
                                            $badgeClass = 'bg-rose-100 text-rose-800';
                                        ?>
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium <?= $badgeClass ?>">
                                            <?= h($estado) ?>
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap">
                                        <div class="flex gap-2 justify-center">
                                            <a href="<?= url('index.php?controller=postulacion&action=edit&id=' . $id) ?>"
                                            ...
                                            <button type="button"
                                                ...
                                                data-id="<?= $id ?>" data-label="Postulación #<?= $id ?>"
                                                data-href="<?= url('index.php?controller=postulacion&action=delete&id=' . $id) ?>">
                                                Eliminar
                                            </button>
                                        </div>
                                    </td>
