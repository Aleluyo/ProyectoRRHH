...
// Asegura que $postulaciones siempre sea un array
...
<body class="min-h-screen bg-white text-vc-ink font-sans relative">
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 py-8 relative">
    ...
    <section class="mt-6">
      <div class="overflow-x-auto rounded-xl border border-black/10 bg-white/90 shadow-soft">
        <table class="min-w-full text-sm" id="tablaPostulaciones">
  ...
  <script>
    ...
    let currentPage = 1;
    let sortField = 'id_postulacion';
    let sortDir = 'asc';
    let filteredData = [...postulacionesData];
