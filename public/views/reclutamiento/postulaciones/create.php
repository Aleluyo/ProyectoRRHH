            ...
            <form method="post" action="<?= url('index.php?controller=postulacion&action=store') ?>" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="id_vacante" name="id_vacante"
                ...
                <div>
                    ...
                    <textarea id="comentarios" name="comentarios" rows="4"
                        class="w-full rounded-lg border border-black/10 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-vc-teal/60"><?= h($old['comentarios'] ?? '') ?></textarea>
                </div>
