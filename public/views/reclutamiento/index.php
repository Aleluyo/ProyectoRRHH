...
require_once __DIR__ . '/../../../config/db.php'; // opcional, igual que en organizacional
...
/** Submódulos del área de Reclutamiento y Selección */
$submodules = [
  [
    'title' => 'Vacantes',
    'sub'   => 'Requisición, aprobación y estatus de vacantes',
    'icon'  => 'bi-briefcase',
  ...
  [
    'title' => 'Postulaciones',
    'sub'   => 'Seguimiento de candidatos por vacante',
    'icon'  => 'bi-kanban',
  ...
  [
    'title' => 'Entrevistas',
    'sub'   => 'Agenda y resultados de entrevistas',
    'icon'  => 'bi-calendar-event',
    'href'  => url('index.php?controller=entrevista&action=index'),
    'tag'   => 'sand',
  ],
];
...
<head>
  <meta charset="UTF-8">
  <title>Reclutamiento y Selección - RRHH</title>
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 py-8 relative">
    ...
    <div class="mb-5">
      <nav class="flex items-center gap-3 text-sm">
        ...
        <span class="font-medium text-vc-pink">Reclutamiento y Selección</span>
      </nav>
    </div>

    <!-- Encabezado del módulo -->
    <section class="text-center mb-7">
      <h1 class="vice-title text-[40px] leading-tight text-vc-ink">Reclutamiento y Selección</h1>
      <p class="mt-1 text-sm sm:text-base text-muted-ink">
        Elige el submódulo con el que deseas trabajar.
      </p>
    </section>

    <!-- Tarjetas de submódulos -->
    <section aria-label="Submódulos de Reclutamiento" class="grid grid-cols-1 md:grid-cols-2 gap-5">
