      ...
      <form id="formCandidatoEdit"
        ...
        <div>
          ...
          <input type="text" id="nombre" name="nombre"
            ...
            value="<?= htmlspecialchars($candidato['nombre'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="email" id="correo" name="correo"
              class="w-full rounded-lg border border-black/10 bg-white/80 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-vc-teal/60"
              value="<?= htmlspecialchars($candidato['correo'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required />
          ...
          <div>
            ...
            <input type="text" id="telefono" name="telefono"
              class="w-full rounded-lg border border-black/10 bg-white/80 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-vc-teal/60"
              value="<?= htmlspecialchars($candidato['telefono'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required />
        ...
        <div>
          ...
          <textarea id="cv" name="cv" rows="4"
            class="w-full rounded-lg border border-black/10 bg-white/80 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-vc-teal/60 resize-y"><?= htmlspecialchars($candidato['cv'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
        </div>
