  ...
  <main class="mx-auto max-w-5xl px-4 sm:px-6 py-8 relative">
    ...
    <div class="mb-5">
      <nav class="flex items-center gap-3 text-sm">
        ...
        <a href="<?= url('index.php?controller=candidato&action=index') ?>"
    ...
    <section class="rounded-xl border border-black/10 bg-white/90 shadow-soft p-5 sm:p-6">
      <form action="<?= url('index.php?controller=candidato&action=store') ?>" method="post" class="space-y-5"
        novalidate>
        <!-- Nombre -->
        <div>
          ...
          <input id="nombre" name="nombre" type="text" required pattern="^[\p{L}\s]+$" title="Sólo letras y espacios."
        ...
        <div>
          ...
          <input id="correo" name="correo" type="email" required value="<?= old_value($old, 'correo') ?>"
        ...
        <div>
          ...
          <input id="telefono" name="telefono" type="tel" required inputmode="numeric" pattern="^\d{8,15}$"
            minlength="8" maxlength="15" title="Sólo números, entre 8 y 15 dígitos."
        ...
        <div>
          ...
          <input id="fuente" name="fuente" type="text" value="<?= old_value($old, 'fuente') ?>"
        ...
        <div>
          ...
          <textarea id="cv" name="cv" rows="4"
            class="mt-1 block w-full rounded-lg border border-black/10 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-vc-teal/60"><?= old_value($old, 'cv') ?></textarea>
        </div>
