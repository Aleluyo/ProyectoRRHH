...
<body class="min-h-screen bg-white text-vc-ink font-sans relative">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="position:absolute;width:0;height:0;overflow:hidden">
    <symbol id="i-users" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      <path d="M16 11a4 4 0 1 0-4-4"/><path d="M22 21a7 7 0 0 0-14 0"/><path d="M8 11a4 4 0 1 0-4-4"/><path d="M14 21a7 7 0 0 0-12 0"/>
    </symbol>
    ...
    <symbol id="i-cal-plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      <rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/><path d="M12 14v6M9 17h6"/>
    </symbol>
    ...
    <symbol id="i-gear" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      <circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06A1.65 1.65 0 0 0 15 19.4a1.65 1.65 0 0 0-1 .6 1.65 1.65 0 0 1-2 0 1.65 1.65 0 0 0-1 .6 1.65 1.65 0 0 0-1.82.33l-.06.06A2 2 0 1 1 6.94 3.29l.06.06A1.65 1.65 0 0 0 8.6 4.6a1.65 1.65 0 0 0 1-.6 1.65 1.65 0 0 0 1 .6 1.65 1.65 0 0 0 1.82-.33l.06-.06A2 2 0 1 1 20.71 6.94l-.06.06A1.65 1.65 0 0 0 19.4 8.6a1.65 1.65 0 0 0 .6 1 1.65 1.65 0 0 1 0 2 1.65 1.65 0 0 0-.6 1z"/>
    </symbol>
  </svg>
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 py-8">
    ...
    <section aria-label="Módulos del sistema" class="grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      ?>
      <a href="<?= $m['href'] ?>" class="group relative rounded-xl border border-black/10 bg-white p-5 flex items-center gap-4 hover:border-vc-teal/30 transition shadow-soft">
        ...
        <div class="shrink-0 rounded-lg border border-black/10 bg-white/80 p-3 text-vc-ink">
          <svg class="h-6 w-6"><use href="#<?= $m['icon'] ?>"/></svg>
        </div>
        <div class="min-w-0">
          <h3 class="font-display text-lg text-vc-ink truncate"><?= htmlspecialchars($m['title'], ENT_QUOTES, 'UTF-8') ?></h3>
        ...
        <div class="ml-auto opacity-0 group-hover:opacity-100 transition text-vc-ink/70">
          <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M9 6l6 6-6 6"/></svg>
        </div>
      </a>
      <?php endforeach; ?>
    </section>
